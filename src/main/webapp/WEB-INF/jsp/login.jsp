...
<title>后台登录 - 成绩信息管理系统 v1.0</title>
...
<div class="loginWraper">
	<div id="loginform" class="loginBox">
		<form class="form form-horizontal" id="login" action="<%=basePath %>/loginIn.action" method="post">
			<div class="row cl">
...
<!-- 			</div> -->
			<div class="row cl">
				<div class="formControls col-xs-8 col-xs-offset-3">
					<input name="" type="button" onclick="loginIn()" class="btn btn-success radius size-L" value="&nbsp;登&nbsp;&nbsp;&nbsp;&nbsp;录&nbsp;">
...
<div class="footer">Copyright 黑龙江八一农垦大学 by 成绩信息管理系统.v1.0</div>
...
// 			layer.msg('登陆失败!',{icon:1,time:1000});
...
// 	});	
	...
	$.post('${basePath}/loginIn.action',{username:userName,password:pwd},function(data){
  		if(data==""||data==null){
