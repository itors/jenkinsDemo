...
<title>修改科目 - 成绩信息管理系统 v1.0</title>
	...
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${t.major }" placeholder="" id="roleName" name="major">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${t.className }"  name="className" id="description">
			</div>
		</div>
		<div class="row cl">
		...
		<input type="hidden" class="input-text" value="${t.cId }" name="cId" id="tId">
	</form>
</article>
...
$(function(){
	...
	$("#form-member-add").validate({
		...
		submitHandler:function(form){
			$.ajax({
                type: 'GET', data: $("#form-member-add").serialize(), url: '${basePath}/tclass/editTClass.action',
