...
<title>修改课程 - 成绩信息管理系统 v1.0</title>
	...
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<select class="select" size="1" id="cId" name="cId" style="width:200px;height:30px;">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<select class="select" size="1" id="sId" name="sId" style="width:200px;height:30px;">
		...
		<input type="hidden" class="input-text" value="${t.scId }" name="scId" id="scId">
	</form>
</article>
...
$(function(){
	...
	$("#form-member-add").validate({
		...
		submitHandler:function(form){
			$.ajax({
                type: 'GET', data: $("#form-member-add").serialize(), url: '${basePath}/sc/editSc.action',
