...
<title>添加用户 - 成绩信息管理系统 v1.0</title>
...
<article class="cl pd-20">
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<select class="select" size="1" id="roleId" name="roleId" style="width:200px;height:30px;">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>用户编码（与原ID一致）：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="" id="userCode" name="userCode">
			</div>
		</div>
...
$(function(){
	...
	$("#form-member-add").validate({
		...
		submitHandler:function(form){
			$.ajax({
                type: 'GET', data: $("#form-member-add").serialize(), url: '${basePath}/user/addUser.action',
