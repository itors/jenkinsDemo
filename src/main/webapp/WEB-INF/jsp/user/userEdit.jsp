...
<title>修改用户 - 成绩信息管理系统 v1.0</title>
	...
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${t.userName }" placeholder="" id="userName" name="userName" readonly="readonly">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>密码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="password" class="input-text" value="${t.userPasswod }" placeholder="" id="userPasswod" name="userPasswod">
			</div>
		</div>
		...
		<input type="hidden" class="input-text" value="${t.userId }" name=userId id="userId">
	</form>
</article>
