...
<title>教师信息 - 教师管理 - 成绩信息管理系统 v1.0</title>
...
<aside class="Hui-aside">
	...
	<c:if  test  = "${sessionScope.roleId eq '1'||sessionScope.roleId eq '2'}"> 
		<dl id="menu-article">
			<dt class="selected"><i class="Hui-iconfont">&#xe616;</i> 教师管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<form action="" id="search1">
				教师：<input type="text" name="tName" id="tName" placeholder=" 教师姓名" style="width:250px" class="input-text">
				专业：<input type="text" name="tMajor" id="tMajor" placeholder=" 专业名称" style="width:250px" class="input-text">
				入职日期：<input type="text" name="" id="entryTime" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'entryTime\')||\'%y-%M-%d\'}'})" class="input-text Wdate" style="width:120px;">
				<button name="search" id="search" class="btn btn-success" type="button" onclick="searchTeacher()"><i class="Hui-iconfont">&#xe665;</i> 搜教师</button>
			</form>
			</div>
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l">
				<a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
				<a class="btn btn-primary radius" data-title="添加教师" onclick="article_add('添加教师','<%=basePath%>/t/tAddPage.action','800','500')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加教师</a>
				</span>
			</div>
			<div class="mt-20">
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<c:forEach items="${list }" var="v" varStatus="status">
						<tr class="text-c">
							<td><input type="checkbox" value="${v.tId}" name="box"></td>
							...
							<td class="f-14 td-manage">
								<a style="text-decoration:none" class="ml-5" onClick="article_edit('教师编辑','<%=basePath%>/t/tEditPage.action?tId=${v.tId}','10001','800','500')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
								<a style="text-decoration:none" class="ml-5" onClick="article_del(this,'${v.tId}')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
						</tr>
						</c:forEach>
					</tbody>
				</table>
...
function datadel(){
	...
	else
	{
		layer.confirm('确认要删除吗？',function(index){
			$.ajax({
				type: 'POST',
				data: {ids:chestr,tb:'t_teacher',id:'t_id'},
