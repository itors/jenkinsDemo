	...
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${t.sName }"  name="sName" id="sName">
			</div>
		</div>
		<div class="row cl">
		...
		<input type="hidden" class="input-text" value="${t.sId }" name="sId" id="sId">
	</form>
</article>
...
$(function(){
	...
	$("#form-member-add").validate({
		...
		submitHandler:function(form){
			$.ajax({
                type: 'GET', data: $("#form-member-add").serialize(), url: '${basePath}/sub/editSub.action',
